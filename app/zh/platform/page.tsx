...
export const metadata = {
  ...
  openGraph: {
    title: "平台 | NeuralFin",
    description: "面向刷屏一代的消费金融界面，连接社交发现、AI 学习与市场行动。",
  },
  twitter: {
    title: "平台 | NeuralFin",
    description: "面向刷屏一代的消费金融界面，连接社交发现、AI 学习与市场行动。",
...
export default function PlatformZhPage() {
  return (
    <SiteChrome
      ...
      hideContact
      eyebrow="平台"
      title={<>面向<span className="accent-inline">刷屏一代</span>的消费金融界面。</>}
      intro="NeuralFin 将微刷屏转化为微学习，将日常金融注意力转化为真实投资理解，连接金融内容、教育、社交洞察与实际投资。"
    >
      <section className="section paper">
        <div className="section-inner product-surface-band">
          <div className="section-head">
            ...
            <p className="section-copy">平台围绕用户已经形成的行为设计：刷屏、关注、讨论、收藏，并在形成判断时进入行动。</p>
          </div>
